...
static char *getConfigFilePath(char *image, char *tag, char *imageDigest)
{
...
static char *getManifestFilePath(char *image, char *tag)
{
    char *base = "/var/lib/ctrc/images";
...
static char *getLayerTarFilePath(char *layerId)
{
...
static char *getLayerJsonFilePath(char *layerId)
{
    char *layDirBase = "/var/lib/ctrc/layers";
